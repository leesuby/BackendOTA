...
Teacher.viewgrade = (req, result) => {
    connection.query(`SELECT g.Name as 'StudentName',15phut_1,15phut_2,15phut_3,15phut_4,45phut_1,45phut_2,giuaki,cuoiki
                FROM Subject s join Grade g on s.id=g.Subject_ID join Student s on g.stuID=s.ID
